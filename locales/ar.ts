export const ar = {
  ...
  // Analytics
  analytics: {
    description: "تحليلات مفصلة ورؤى",
    userGrowth: "نمو المستخدمين",
    revenueTrend: "اتجاه الإيرادات",
    combined: "تحليلات مجمعة",
    users: "المستخدمون",
    revenue: "الإيرادات",
  },
  ...
  settings: {
    ...
    modalStyle: {
      ...
      options: {
        default: { name: "افتراضي", description: "نافذة في المنتصف" },
        centered: { name: "متمركز", description: "دائماً في المنتصف" },
        fullscreen: { name: "ملء الشاشة", description: "يغطي الشاشة بالكامل" },

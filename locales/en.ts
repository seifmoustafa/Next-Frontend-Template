export const en = {
    ...
    "layout.minimalDesc": "Minimal design with top navigation only and dropdown menus",
    "layout.compactDesc": "Compact design with small elements to maximize content space",

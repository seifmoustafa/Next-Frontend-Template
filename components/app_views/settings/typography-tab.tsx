    ...
    <>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Logo Animation */}
          <div className="space-y-3">
            <Label className="text-sm font-semibold">Logo Animation</Label>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { value: "none", name: "None", description: "No animation" },
                { value: "spin", name: "Spin", description: "Rotating animation" },
                { value: "pulse", name: "Pulse", description: "Pulsing effect" },
                { value: "fancy", name: "Fancy", description: "Hover effects" },
              ].map((animation) => (
                <div
                  key={animation.value}
                  className={cn(

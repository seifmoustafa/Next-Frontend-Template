    ...
    compoundVariants: [
      {
        variant: "success",
        design: "gradient",
        class: "from-green-500 to-emerald-500 text-white border-0",
      },
      {
        variant: "destructive",
        design: "gradient", 
        class: "from-red-500 to-rose-500 text-white border-0",
      },
      {
        variant: "warning",
        design: "gradient",
        class: "from-yellow-500 to-orange-500 text-white border-0",
      },
      {
        variant: "info",
        design: "gradient",
        class: "from-blue-500 to-cyan-500 text-white border-0",
      },
      {
        variant: "success",
        design: "outlined",
        class: "border-green-500 text-green-700 dark:text-green-300",
      },
      {
        variant: "destructive",
        design: "outlined",
        class: "border-red-500 text-red-700 dark:text-red-300",
      },
      {
        variant: "warning",
        design: "outlined",
        class: "border-yellow-500 text-yellow-700 dark:text-yellow-300",
      },
      {
        variant: "info",
        design: "outlined",
        class: "border-blue-500 text-blue-700 dark:text-blue-300",
      },
    ],
    defaultVariants: {
      variant: "default",
...
>(({ className, variant, design, ...props }, ref) => {
  return (

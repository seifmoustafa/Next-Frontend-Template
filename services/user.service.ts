...
export interface IUserService {
  getUsers(params?: { page?: number; pageSize?: number; search?: string }): Promise<UsersResponse>
...
export class UserService implements IUserService {
  ...
  async getUsers(params?: { page?: number; pageSize?: number; search?: string }): Promise<UsersResponse> {
    try {
      ...
      const response = await this.apiService.get<UsersResponse>(`/admins?${queryParams.toString()}`)
      return response
    } catch (error) {
